...
public class formatting {
    ...
    public void bindFormatting(Player player) {
        ...
        new Tab(player, ChatColor.AQUA + "Welcome to "+ "" + ChatColor.BOLD + ChatColor.GOLD + "MC.CHIVAL.AU", ChatColor.AQUA + "Do " + ChatColor.DARK_GREEN + "/help" + ChatColor.AQUA + " for help!");
